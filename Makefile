NAME = crossy_roadster
BONUS_NAME = multiplayer
CC = cc
...
all: make_mlx add_flag1 $(NAME)

make_mlx:
	@make -C $(MLX_PATH)

$(NAME): $(OBJS) $(LIBFT)
	$(CC) $(OBJS) $(INC) $(LIBFT) $(MLX) $(MLX_FLAGS) -o $(NAME)
...
$(BONUS_OBJ_DIR)/%.o: $(SRC_DIR)/%.c
	...
	$(CC) $(CFLAGS) $(BONUS_FLAGS) -c $< -o $@ $(INC)

$(BONUS_NAME): $(BONUS_OBJS) $(LIBFT)
	$(CC) $(BONUS_OBJS) $(INC) $(MLX) $(MLX_FLAGS) $(LIBFT) -o $(BONUS_NAME)
...
bonus: make_mlx add_flag2 $(BONUS_NAME)
